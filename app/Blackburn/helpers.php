...
function miscLinks()
{
    return [
        ...
        ['label' => trans('labels.albums'), 'uri' => '/albums'],
        ['label' => trans('labels.packages'), 'uri' => '/packages'],
        ['label' => trans('labels.tours'), 'uri' => '/tours'],
        ['label' => trans('labels.nile-cruises'), 'uri' => '/nile-cruises'],
        ['label' => trans('labels.hotels'), 'uri' => '/hotels'],
    ];
}
