...
trait ImageUploadTrait {
    ...
    {
        $width = isset($this->upload_options['thumb_width']) ? $this->upload_options['thumb_width'] : 200;
        $height = isset($this->upload_options['thumb_height']) ? $this->upload_options['thumb_height'] : 200;
    ...
    public function generateWatermark()
    {
        ...
        /*$insert = isset($this->upload_options['watermark']['url'])
            ? $this->upload_options['watermark']['url']
            : public_path('assets/site/images/logo.png');*/
