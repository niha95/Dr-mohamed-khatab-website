...
class SideMenuComposer {
    ...
    public function sideMenu()
    {
        return [
            ...
            'nile-cruises' => [
                'title' => trans('labels.nile-cruises'),
                'options' => [
                    'control_panel.nile-cruises.create' => [
                        'label' => trans('actions.add_entity', ['entity' => trans('labels.nile-cruise')]),
                        'link' => route('control_panel.nile-cruises.create'),
                        'icon' => 'fa fa-plus'
                    ],
                    'control_panel.nile-cruises.index' => [
                        'label' => trans('actions.list_entities', ['entities' => trans('labels.nile-cruises')]),
                        'link' => route('control_panel.nile-cruises.index'),
                        'icon' => 'fa fa-list',
                    ],
                ]
            ],
