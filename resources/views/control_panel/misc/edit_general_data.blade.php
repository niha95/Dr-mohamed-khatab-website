...
@section('content')
    {{ Form::model($data, ['route' => 'control_panel.misc.edit_general_data', 'class' => 'form-horizontal', 'method' => 'patch', 'files' => true]) }}
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                {{ Form::textarea('site_word_content_' . $locale, null,
                                    ['class' => 'form-control ck_editor', 'id' => 'SiteWordContent_' . $locale, 'placeholder' => trans('labels.site_word_content')]) }}
                            </div>
                        </div>
