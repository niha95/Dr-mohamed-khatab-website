    ...
    {{ Form::model($data, ['route' => 'control_panel.misc.edit_contact_data', 'class' => 'form-horizontal', 'method' => 'patch']) }}
        ...
        <div class="row">
            ...
            <div class="col-sm-5">
                ...
                >
                    <div class="section">
                        <entities-list :entities.sync="phone_numbers" :entities_label="translations.phone_numbers"></entities-list>
                        <input type="hidden" name="phone_numbers" v-model="phone_numbers_json">
                    </div>
