    ...
    <template id="PageTemplate">
        <div id="LinkSelector__Page">
            ...
            <div v-if="categories && categories.length != 0">
                <div class="row" v-for="chunk in categories.chunk(4)">
                    <div class="col-sm-3" v-for="item in chunk">
            ...
            <div v-if="pages && pages.length != 0">
                <div class="row" v-for="chunk in pages.chunk(4)">
                    <div class="col-sm-3" v-for="item in chunk">
                        <div class="item" v-bind:class="{ selected: isSelected(item) }"
                             v-on:click.prevent="selectItem(item)"
                        >
                        ...
                        fetchCategoriesAndPages: function(category){
                            ...
                            this.$http.get(this.urls.fetch_categories_and_pages, {params: {parent_id: parent_id}})
                                    .then(function (response) {
                                        ...
                                        self.categories = resData.categories;
                                        self.pages = resData.pages;
                                        self.path = resData.path;
