                    ...
                    <table class="table table-hover">
                        ...
                        @foreach($categories as $i => $category)
                            <tr>
                                ...
                                <td>
                                    @if(!empty($category->featuredImage))
                                        <img src="{{ $category->featuredImage->thumbFullLink() }}"
                                             alt="{{ $category->title_default }}"
                                ...
                                <td class="text-center">
                                    @if($category->parent)
                                        <a href="{{ route('control_panel.products_categories.edit', [$category->parent->slug]) }}">
                                ...
                                <td nowrap class="text-center">
                                    ...
                                    <a href="javascript: void(0)"
                                       data-url="{{ route('control_panel.products_categories.destroy', $category->id) }}"
