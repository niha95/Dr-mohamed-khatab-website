        ...
        <div class="section">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    ...
                    <label class="radio-inline">
                        {{ Form::radio('role', 'marketing_representative', false) }} {{ trans('roles.marketing_representative') }}
                    </label>
                    <label class="radio-inline">
                        {{ Form::radio('role', 'marketing_supervisor', false) }} {{ trans('roles.marketing_supervisor') }}
                    </label>
                    <label class="radio-inline">
                        {{ Form::radio('role', 'sales_representative', false) }} {{ trans('roles.sales_representative') }}
                    </label>
                    <label class="radio-inline">
                        {{ Form::radio('role', 'sales_supervisor', false) }} {{ trans('roles.sales_supervisor') }}
                    </label>
                    <label class="radio-inline">
                        {{ Form::radio('role', 'distribution_representative', false) }} {{ trans('roles.distribution_representative') }}
                    </label>
                </div>
            </div>
        </div>
