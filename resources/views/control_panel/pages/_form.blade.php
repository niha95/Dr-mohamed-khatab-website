            ...
            <div class="section">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-12">
                        ...
                        <label class="radio-inline">
                            {{ Form::radio('status_' . $locale, 'inactive', false) }} vedio
                        </label>
                        <label class="radio-inline">
                ...
                <div class="form-group">
                    {{ Form::label('vedio','vedio', ['class' => 'col-sm-12']) }}
                    <div class="col-sm-12">
                        {{ Form::textarea('vedio', null,
                            ['class' => 'form-control', 'id' => 'vedio',
                                'placeholder' => 'vedio url', 'rows' => 3]) }}
                    </div>
                </div>
            </div>
        @endforeach
